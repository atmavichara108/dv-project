...
Панель управления проектом «Дискуссионные Вечера». Здесь ведётся стратегия, структура движения, методология исследований и операционка. Сами исследования (материалы, темы, дискуссии) живут на сайте DV Hub — https://dv-hub.pages.dev
...
## Структура проекта
    ...
    │   ├── Исследования/       — методология, воркфлоу, не сами материалы
